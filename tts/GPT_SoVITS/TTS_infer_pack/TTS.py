...
from tts.GPT_SoVITS.AR.models.t2s_lightning_module import Text2SemanticLightningModule
from tts.GPT_SoVITS.feature_extractor.cnhubert import CNHubert
from tts.GPT_SoVITS.module.models import SynthesizerTrn
from tts.tools.i18n.i18n import I18nAuto, scan_language_list
from tts.tools.my_utils import load_audio
from tts.GPT_SoVITS.module.mel_processing import spectrogram_torch
from tts.GPT_SoVITS.TTS_infer_pack.text_segmentation_method import splits
from tts.GPT_SoVITS.TTS_infer_pack.TextPreprocessor import TextPreprocessor
...
class TTS_Config:
    default_configs={
        "default":{
                ...
                "is_half": False,
                "version": "v1",
                "t2s_weights_path": "/root/chat2audio/tts/GPT_SoVITS/pretrained_models/s1bert25hz-2kh-longer-epoch=68e-step=50232.ckpt",
                "vits_weights_path": "/root/chat2audio/tts/GPT_SoVITS/pretrained_models/s2G488k.pth",
                "cnhuhbert_base_path": "/root/chat2audio/tts/GPT_SoVITS/pretrained_models/chinese-hubert-base",
                "bert_base_path": "/root/chat2audio/tts/GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large",
            },
        "default_v2":{
                "device": "cpu",
                "is_half": False,
                "version": "v2",
                "t2s_weights_path": "/root/chat2audio/tts/GPT_SoVITS/pretrained_models/gsv-v2final-pretrained/s1bert25hz-5kh-longer-epoch=12-step=369668.ckpt",
                "vits_weights_path": "/root/chat2audio/tts/GPT_SoVITS/pretrained_models/gsv-v2final-pretrained/s2G2333k.pth",
                "cnhuhbert_base_path": "/root/chat2audio/tts/GPT_SoVITS/pretrained_models/chinese-hubert-base",
                "bert_base_path": "/root/chat2audio/tts/GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large",
            },
    }
    ...
    def __init__(self, configs: Union[dict, str]=None):
        ...
        # 设置默认配置文件路径
        configs_base_path:str = "/root/chat2audio/tts/GPT_SoVITS/configs/"
